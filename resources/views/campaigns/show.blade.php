...
@section('content')
@include('components.header', ['title' => 'Campaña '.$campaign->name])
    ...
    <div class="row">
        <div class="col-xl-6 col-sm-12">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    @include('expedientes.components.simpleTable', ['expedientes'=>$sentExpedientes, 'notSent' =>
                    false])
                </div>
            </div>
        </div>
            ...
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('campaign.send') }}" method="post">
                        ...
                        @include('expedientes.components.simpleTable', ['expedientes'=>$notSentExpedientes, 'notSent' =>
                        true])
                        @if (count($notSentExpedientes) > 0)
