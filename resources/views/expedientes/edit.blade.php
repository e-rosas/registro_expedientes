                ...
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-3 text-right">
                            <a href="{{ route('expedientes.index') }}" class="btn btn-sm btn-primary">Lista de
                                expedientes</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('expedientes.update', $expediente) }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-row">
                                <div class="form-group{{ $errors->has('full_name') ? ' has-danger' : '' }} col-md-12">
                                    ...
                                    <input type="text" name="full_name" id="input-full_name"
                                        ...
                                        placeholder="Nombre completo" value="{{ $expediente->full_name }}" required
                                        autofocus>
                                ...
                                <div class="form-group{{ $errors->has('birth_date') ? ' has-danger' : '' }} col-md-4">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input name="birth_date" id="input-birth_date"
                                            ...
                                            type="date" required value="{{ $expediente->birth_date->format('Y-m-d') }}">
                                    </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }} col-md-6">
                                    ...
                                    <input type="text" name="address" id="input-address"
                                        ...
                                        placeholder="Correo opcional" value="{{ $expediente->address }}">
                            ...
                            <div class="form-row">
                                <div
                                    class="form-group{{ $errors->has('year') ? ' has-danger' : '' }} col-md-4 col-auto">
                                    <label class="form-control-label" for="input-year">Año</label>
                                    <input type="numeric" name="year" id="input-year"
                                ...
                                <div class="custom-control custom-control-alternative custom-checkbox mb-3">
                                    <input type="checkbox" name="insured" id="input-insured"
                                        class="custom-control-input" {{ $expediente->insured ? 'checked' : '' }}>
