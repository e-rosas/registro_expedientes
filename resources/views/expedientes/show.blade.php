                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-row">
                                {{--  Concept  --}}
                                <div class="col-md-7 col-auto form-group">
                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-7 text-right">
                                <button type="button" class="btn btn-block btn-success" data-toggle="modal" data-target="#modal-call">Registrar nueva</i></button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
