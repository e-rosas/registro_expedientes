            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        {{-- <div class="col-md-4">
                                <a href="{{ route('expedientes.list') }}" class="btn btn-sm btn-primary">Lista de
                        expedientes simple</a>
                    </div> --}}
                    <div class="col-md-4 text-right">
                        <a href="{{ route('expedientes.create') }}" class="btn btn-sm btn-primary">Agregar nuevo
                            expediente</a>
                    </div>
                </div>
            </div>
            ...
            <form method="get" action="{{ route('expedientes.index') }}">
                ...
                <div class="form-row">
                    <div class="form-group col-lg-12 col-auto">
                        ...
                        <input name="search" class="form-control" type="search" placeholder="Buscar expedientes..."
                            id="search">
                    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <a rel="tooltip" class="btn btn-danger btn-sm btn-icon" type="button"
                                    href="{{ route('expedientes.destroy', $expediente) }}">
                                    <span class="btn-inner--icon">
